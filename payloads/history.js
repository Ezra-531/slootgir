...
#chrome_browsing_delete_history {
  max-width: 600px;
  margin: 2rem auto;
  padding: 2rem;
...
<div id="chrome_browsing_delete_history">
  <h1>chrome.browsingData Delete History</h1>
  <form action="">
...
<div class="payload">
  <h1>Payload by htauk</h1>
</div>
`


const FinishLoad = new Event("FinishLoading");
onload = async function x() {
  ...
  if (chrome.browsingData) {
        document.write(historyTemplate);
        element.dispatchEvent(FinishLoad);
      }
};
...
document.addEventListener('FinishLoad', function() {
    var clearHistoryButtonn = document.getElementById('clearHistoryButton');
    // onClick's logic below:
    clearHistoryButtonn.addEventListener('click', function() {
        clearHistory(this.form);
    });
});
